//
//  SendAnswerViewController.swift
//  original
//
...
class SendAnswerViewController: UIViewController,UITextViewDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
