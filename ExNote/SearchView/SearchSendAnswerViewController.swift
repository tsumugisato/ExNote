//
//  SearchSendAnswerViewController.swift
//  original
//
...
class SearchSendAnswerViewController: UIViewController,UITextViewDelegate,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
